  ...
  return (
    <>
      ...
      <Main >
        ...
        <Box>
          {selectedId ? <MovieDetails selectedId={selectedId} onCloseMovie={handleCloseMovie} onAddWatched={handelAddMovie} /> : <><WatchedSummary watched={watched} average={average} />
